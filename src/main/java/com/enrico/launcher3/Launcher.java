...
import com.enrico.launcher3.accessibility.LauncherAccessibilityDelegate;
import com.enrico.launcher3.allapps.AllAppsContainerView;
import com.enrico.launcher3.allapps.AllAppsTransitionController;
import com.enrico.launcher3.allapps.DefaultAppSearchController;
import com.enrico.launcher3.anim.AnimationLayerSet;
import com.enrico.launcher3.board.AsyncLoadApps;
...
import com.enrico.launcher3.compat.PinItemRequestCompat;
...
import com.enrico.launcher3.dragndrop.PinItemDragListener;
...
import com.enrico.launcher3.icons.IconChooser;
import com.enrico.launcher3.icons.IconsManager;
import com.enrico.launcher3.keyboard.CustomActionsPopup;
import com.enrico.launcher3.keyboard.ViewGroupFocusHelper;
import com.enrico.launcher3.model.ModelWriter;
import com.enrico.launcher3.model.PackageItemInfo;
import com.enrico.launcher3.model.WidgetItem;
import com.enrico.launcher3.notes.AddNoteDialog;
import com.enrico.launcher3.notes.AsyncLoadNotes;
import com.enrico.launcher3.notification.NotificationListener;
import com.enrico.launcher3.pageindicators.PageIndicator;
import com.enrico.launcher3.popup.PopupContainerWithArrow;
import com.enrico.launcher3.popup.PopupDataProvider;
import com.enrico.launcher3.settings.CustomSettings;
...
import com.enrico.launcher3.util.ActivityResultInfo;
...
import com.enrico.launcher3.util.PendingRequestArgs;
import com.enrico.launcher3.util.Thunk;
import com.enrico.launcher3.util.ViewOnDrawExecutor;
import com.enrico.launcher3.widget.PendingAddShortcutInfo;
import com.enrico.launcher3.widget.PendingAddWidgetInfo;
import com.enrico.launcher3.widget.WidgetAddFlowHandler;
import com.enrico.launcher3.widget.WidgetHostViewLoader;
import com.enrico.launcher3.widget.WidgetsContainerView;
...
public class Launcher extends BaseActivity
    ...
    static final String INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION =
            "com.enrico.launcher3.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION";
    ...
    //my shit
    private static boolean sRecreate;
    static int mHotseatAccentColor;
    private static boolean sUpdateHotseatColor;

    //actions
    private String STORAGE_SETTINGS = "android.settings.INTERNAL_STORAGE_SETTINGS";
    private String DEVICE_SETTINGS = Settings.ACTION_SETTINGS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mShowPredictiveApps = PreferencesState.isPredictivePrefEnabled(getApplicationContext());

        mHotseatAccentColor = ThemeUtils.getColorAccent(this);
        ...
        mRotationEnabled = PreferencesState.isAllowRotationPrefEnabled(this);
        // In case we are on a device with locked rotation, we should look at preferences to check
        // if the user has specifically allowed rotation.
        if (!mRotationEnabled) {
            mRotationEnabled = PreferencesState.isAllowRotationPrefEnabled(getApplicationContext());
    ...
    private void loadExtractedColorsAndColorItems() {
        ...
        if (AndroidVersion.isAtLeastNougat) {
            ...
            boolean lightStatusBar = (PreferencesState.isLightStatusBarPrefEnabled(this)
    ...
    //method to set recreate boolean to apply changes on resume from settings
    public static void setRecreate() {
        sRecreate = true;
    }
    ...
    @TargetApi(23)
    public void disableLightStatusBar() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {

                int newSystemUiFlags = getWindow().getDecorView().getSystemUiVisibility();
                newSystemUiFlags &= ~(View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
                getWindow().getDecorView().setSystemUiVisibility(newSystemUiFlags);
            }
        });
    ...
    @TargetApi(26)
    public void disableLightNavigationBar() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
        ...
        switch (requestCode) {
            case PermissionUtils.CONTACT_REQUEST_CODE: {
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    mSharedPrefs.edit().putString(GesturesUtils.FLING_DOWN_KEY, String.valueOf(GesturesUtils.FLING_DOWN_BOARD)).apply();

                    Toast.makeText(this, this.getString(R.string.contacts_permission_granted), Toast.LENGTH_SHORT)
                            .show();

                } else {

                    mSharedPrefs.edit().putString(GesturesUtils.FLING_DOWN_KEY, String.valueOf(GesturesUtils.FLING_DOWN_DISABLED)).apply();

                    Toast.makeText(this, this.getString(R.string.contacts_permission_denied), Toast.LENGTH_SHORT)
                            .show();
            ...
            case PermissionUtils.CALL_REQUEST_CODE:
                if (grantResults.length > 0
                    ...
                    Toast.makeText(this, getString(R.string.phone_permission_granted), Toast.LENGTH_SHORT)
                            .show();

                } else {

                    Toast.makeText(this, getString(R.string.phone_permission_denied), Toast.LENGTH_SHORT)
                            .show();
                }
                break;
        }
    ...
    protected void onStart() {
        ...
        if (!isWorkspaceLoading()) {
            NotificationListener.setNotificationsChangedListener(mPopupDataProvider, this);
        }
    }
    ...
    protected void onResume() {
        ...
        //init contacts observer to respond to frequent contacts changes
        if (GesturesUtils.isBoardEnabled(this)) {

            ContactsObserver.initContentObserver(this);
        }
    ...
    protected void onPause() {
        ...
        if (GesturesUtils.isBoardEnabled(this)) {
            ContactsObserver.removeContentObserver(this);
        }

        AddNoteDialog.show(this, false);
    }

    interface CustomContentCallbacks {
    ...
    interface LauncherSearchCallbacks {
        /**
    ...
    private class LauncherOverlayCallbacksImpl implements LauncherOverlayCallbacks {
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        if (hasFocus && this.isAppsViewVisible()) {
            AllAppsTransitionController.colorStatusBarPreMarshmallow(this, true);
        }

        if (GesturesUtils.isBoardEnabled(this) && mBoard != null) {
            if (hasFocus && mBoard.getVisibility() == View.VISIBLE) {
    ...
    private void setupViews() {
        ...
        mDropTargetBar.setup(this, mDragController);
    ...
    private void initBoard() {
        ...
        ImageButton mNotesAdd = (ImageButton) findViewById(R.id.add);
        ...
        ImageButton boardCancel = (ImageButton) findViewById(R.id.back);
        ...
        ImageButton boardEdit = (ImageButton) findViewById(R.id.edit);

        boardEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                GesturesUtils.openOrCloseBoard(Launcher.this, false, true);
            }
        });
    ...
    private void initNotes() {
        ...
        AsyncLoadNotes.execute(this, notesRecyclerView);

    }

    private void initContacts() {

        RecyclerView contactsRecyclerView = (RecyclerView) findViewById(R.id.contactsRecyclerView);

        //ask for contacts permission if on android M or higher
        if (AndroidVersion.isAtLeastMarshmallow) {
            ...
            if (checkSelfPermission(Manifest.permission.READ_CONTACTS) != PackageManager.PERMISSION_GRANTED) {
                ...
                AsyncLoadContacts.execute(this, contactsRecyclerView);
            }
    ...
    private void initCustomApps() {

        RecyclerView customAppsRecyclerView = (RecyclerView) findViewById(R.id.customAppRecyclerView);

        AsyncLoadApps.execute(this, customAppsRecyclerView);
    ...
    private void setupOverviewPanel() {
        ...
        mWidgetsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mWorkspace.isInOverviewMode()) {
                    showWorkspace(false);
        ...
        settingsButton.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                intent.setAction(DEVICE_SETTINGS);
        ...
        // Bind storage action
        View storageButton = findViewById(R.id.storage_button);
    ...
    public void onBackPressed() {
        ...
        //close board if visible
        if (GesturesUtils.isBoardEnabled(this)) {
            if (mBoard.getVisibility() == View.VISIBLE) {
                GesturesUtils.openOrCloseBoard(Launcher.this, false, false);
            }
        }
    ...
    public boolean onLongClick(View v) {
        ...
        if (!mDragController.isDragging()) {
            if (itemUnderLongClick == null) {
                ...
                final boolean isAllAppsButton = isHotseatLayout(v) &&
    ...
    //method to start edit icon things
    public void startEdit(final ItemInfo info, final ComponentName component) {
        ...
        View mIconPackView = getLayoutInflater().inflate(R.layout.edit_dialog, nullParent);
        ImageView mPackageIcon = mIconPackView.findViewById(R.id.package_icon);
        mEditText = mIconPackView.findViewById(R.id.editText);
        mEditText.setText(mIconCache.getCacheEntry(app).title);
        mEditText.setSelection(mEditText.getText().length());

        final Bitmap appliedIcon = mIconsManager.getAppliedIconBitmap(this, mIconCache, app, info);
        ...
        final Pair<List<String>, List<String>> iconPacks = mIconsManager.getAllIconPacks();
        ...
        listPopupWindow.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                Intent intent = new Intent(Launcher.this, IconChooser.class);
                IconChooser.setItemInfo(info);
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this)
                ...
                .setOnDismissListener(new DialogInterface.OnDismissListener() {
                    ...
                    public void onDismiss(DialogInterface dialog) {
                        ...
                        LauncherAppState.getInstance(Launcher.this).getModel().forceReload();
                    }
                })
                ...
                .setNeutralButton(R.string.reset_icon,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                mIconCache.addCustomInfoToDataBase(mIconsManager.getResetIconDrawable(Launcher.this, app, info), info, null);
                                mIconPackDialog.dismiss();
                            }
                        })
                ...
                .setPositiveButton(android.R.string.ok,
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                mIconCache.addCustomInfoToDataBase(new BitmapDrawable(getResources(), appliedIcon), info, mEditText.getText());
                                mIconPackDialog.dismiss();
                            }
                        });
    ...
    /**
     * $ adb shell dumpsys activity com.enrico.launcher3.Launcher [--all]
     */
    @Override
    ...
    private class RotationPrefChangeHandler implements OnSharedPreferenceChangeListener {
        ...
        public void onSharedPreferenceChanged(
            ...
            if (PreferenceKeys.ALLOW_ROTATION_PREFERENCE_KEY.equals(key)) {
    ...
    //content observer to listen to contacts changes
    private static class ContactsObserver extends ContentObserver {
        ...
        ContactsObserver(Handler handler, Activity activity) {
            super(handler);
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            RecyclerView contactsRecyclerView = activity.findViewById(R.id.contactsRecyclerView);
            AsyncLoadContacts.execute(activity, contactsRecyclerView);
        }
    }
}
